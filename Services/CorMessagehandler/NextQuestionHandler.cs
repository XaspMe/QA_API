...
public class NextQuestionHandler : MessageHandler
{
    ...
    public NextQuestionHandler(IQaRepo repo, Dictionary<long, int> userCurrentQuestion, ITelegramBotClient telegramBotClient, long chatId, CancellationToken ct)
    {
        _repo = repo;
        _chatId = chatId;
        _ct = ct;
    ...
    public override async Task HandleMessage(Message message)
    {
        ...
        {
            var question = _repo.GetElementRandom();
            _userCurrentQuestion[_chatId] = question.Id;
