...
public static class TelegramCommands
{
    ...
    public const string SHOW_CATEGORIES_STATISTICS = "Показать статистику по категория";
}
...
public static class TelegramMarkups
{
    ...
    public static readonly ReplyKeyboardMarkup MAIN_MENU = new(new[]
    {
        new KeyboardButton[] { "\ud84d " + TelegramCommands.CATEGORIES, "\U00002b50 " + TelegramCommands.FAVORITES_QUESTIONS },
        new KeyboardButton[] { "\u260f " + TelegramCommands.CONTACTS, "\U0001F48C " + TelegramCommands.FEEDBACK }
    });

    public static readonly ReplyKeyboardMarkup ADMIN_MENU = new(new[]
    {
        new KeyboardButton[] { "\ud84d " + TelegramCommands.CATEGORIES, "\U00002b50 " + TelegramCommands.FAVORITES_QUESTIONS },
        new KeyboardButton[] { "\u260f " + TelegramCommands.CONTACTS, "\U0001F48C " + TelegramCommands.FEEDBACK },
        new KeyboardButton[] { TelegramCommands.EDIT_QUESTION, TelegramCommands.ADD_QUESTION },
        new KeyboardButton[] { TelegramCommands.DELETE_QUESTION, TelegramCommands.CHANGE_QUESTION_CATEGORY },
        new KeyboardButton[] { TelegramCommands.RENAME_CATEGORY, TelegramCommands.ADD_CATEGORY },
        new KeyboardButton[] { TelegramCommands.DELETE_CATEGORY, TelegramCommands.SHOW_CATEGORIES_STATISTICS}
    });
